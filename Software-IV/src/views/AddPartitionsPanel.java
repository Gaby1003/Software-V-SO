...
public class AddPartitionsPanel extends JPanel {
    ...
    public AddPartitionsPanel(ActionListener listener, String title){
    ...
    private void initComponents() {
		...
		element.setColumnIdentifiers(Constant.HEADER_PARTITIONS);
