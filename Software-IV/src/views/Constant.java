...
public class Constant {
    ...
    public static final Color COLOR_WHITE = Color.decode("#f8f8f8");
    public static final Color COLOR_BLACK = Color.decode("#000000");
    public static final Color COLOR_RED = Color.decode("#17A589");
    public static final Color COLOR_GRAY = Color.decode("#F1F1F1");
    public static final Color COLOR_BLUE = Color.decode("#46AFF6");
    public static final Color COLOR_RED_2 = Color.decode("#F64646");
