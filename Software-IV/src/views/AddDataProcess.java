...
public class AddDataProcess extends JPanel {
	...
	public JPanel addButtonNewProcess(ActionListener listener) {
		...
		JButtonInformation addProcess = new JButtonInformation(10, 10, "Agregar proceso", Constant.COLOR_RED,
		...
		JButtonInformation start = new JButtonInformation(10, 10, "Iniciar simulaci\u00f3n", Constant.COLOR_RED,
        Color.white, Constant.FONT_NUNITO);
		start.setActionCommand(Events.START_SIMULATION.toString());
		start.addActionListener(listener);

		JButtonInformation editProcess = new JButtonInformation(10, 10, "Editar proceso", Constant.COLOR_RED,
        Color.white, Constant.FONT_NUNITO);
